...
class Ui_FrmKit(object):
    def setupUi(self, FrmKit):
        ...
        self.txtCodigo_kit.setObjectName("txtCodigo_kit")
        ...
        self.txtDesc_kit.setObjectName("txtDesc_kit")
        ...
        icon1 = QIcon()
        icon1.addFile(
            ":/Icons/PNG/Exit.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        self.spinCantidad.setStyleSheet(
        ...
        self.spinCoste.setObjectName("spinCoste")
        self.spinCoste.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "color: rgb(0, 0, 0);"
        )
        self.spinCoste.setAlignment(
        ...
        self.lblCoste.setObjectName("lblCoste")
        self.lblCoste.setAlignment(
            Qt.AlignmentFlag.AlignRight
            | Qt.AlignmentFlag.AlignTrailing
            | Qt.AlignmentFlag.AlignVCenter
        )
        ...
        self.spinDto.setObjectName("spinDto")
        ...
        self.btnRomperKit.setObjectName("btnRomperKit")
        icon3 = QIcon()
        icon3.addFile(
        ...
        self.spinCantRomper.setObjectName("spinCantRomper")
        self.spinCantRomper.setAlignment(
            Qt.AlignmentFlag.AlignRight
            | Qt.AlignmentFlag.AlignTrailing
            | Qt.AlignmentFlag.AlignVCenter
        )
        ...
        icon4 = QIcon()
        icon4.addFile(
            ":/PNG/resources/icons/png/down_arrow.png",
            QSize(),
            QIcon.Mode.Normal,
            QIcon.State.Off,
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.tabla_buscar.sizePolicy().hasHeightForWidth()
        )
        ...
        self.btnAnadirKits.setObjectName("btnAnadirKits")
        icon5 = QIcon()
        icon5.addFile(
    ...
    def retranslateUi(self, FrmKit):
        FrmKit.setWindowTitle(
            QCoreApplication.translate(
                "FrmKit", "Gesti\u00f3n de Kits de producto.", None
            )
        )
        self.label_7.setText(QCoreApplication.translate("FrmKit", "C\u00f3digo:", None))
        self.btnQuitar.setText(
            QCoreApplication.translate("FrmKit", "Quitar producto", None)
        )
        self.pushButton.setText(QCoreApplication.translate("FrmKit", "Cerrar", None))
        self.label_8.setText(QCoreApplication.translate("FrmKit", "Coste en Kit", None))
        self.label_5.setText(
            QCoreApplication.translate("FrmKit", "Descripci\u00f3n:", None)
        )
        self.label_4.setText(QCoreApplication.translate("FrmKit", "C\u00f3digo:", None))
        self.label_6.setText(QCoreApplication.translate("FrmKit", "Dto:", None))
        self.label_3.setText(QCoreApplication.translate("FrmKit", "Cantidad:", None))
        self.lblCoste.setText(QCoreApplication.translate("FrmKit", "0,0", None))
        self.label_9.setText(QCoreApplication.translate("FrmKit", "Coste:", None))
        self.btnGuardar.setText(
            QCoreApplication.translate("FrmKit", "<<Agregar(2)", None)
        )
        self.btnRomperKit.setText(
            QCoreApplication.translate("FrmKit", "Romper Kit", None)
        )
        self.label_12.setText(
            QCoreApplication.translate(
                "FrmKit",
                "Romper Kits (A\u00f1adir\u00e1 stock\n" "a los productos del kit):",
                None,
            )
        )
        self.label_10.setText(QCoreApplication.translate("FrmKit", "Sentido:", None))
        self.btnAnadir.setText(
            QCoreApplication.translate("FrmKit", "Preparar componente kit (1)", None)
        )
        self.label_2.setText(QCoreApplication.translate("FrmKit", "Buscar por:", None))
        self.label.setText(QCoreApplication.translate("FrmKit", "Filtro:", None))
        self.btnAnadirKits.setText(
            QCoreApplication.translate("FrmKit", "A\u00f1adir stock Kit (3)", None)
        )
        self.label_11.setText(
            QCoreApplication.translate(
                "FrmKit",
                "Crear Kits (Descontar\u00e1 stock\n" "de los productos kit):",
                None,
            )
        )
