...
def upgrade() -> None:
    ...
    op.add_column(
        "empresas", sa.Column("forma_juridica", sa.String(100))
    )  # S.L., S.A., etc.
    ...
    op.add_column(
        "empresas", sa.Column("activar_modo_internacional", sa.Boolean(), default=False)
    )
    op.add_column(
        "empresas", sa.Column("actualizar_valores_divisa", sa.Boolean(), default=False)
    )
    op.add_column("empresas", sa.Column("id_moneda_principal", sa.Integer()))

    # Configuración fiscal
    op.add_column(
        "empresas", sa.Column("regimen_iva", sa.String(50), default="General")
    )
    op.add_column("empresas", sa.Column("tipo_retencion", sa.String(50)))
    op.add_column(
        "empresas", sa.Column("aplicar_retencion", sa.Boolean(), default=False)
    )
    op.add_column(
        "empresas", sa.Column("porcentaje_retencion", sa.Float(), default=0.0)
    )
    op.add_column("empresas", sa.Column("exento_iva", sa.Boolean(), default=False))
    op.add_column(
        "empresas", sa.Column("intracomunitario", sa.Boolean(), default=False)
    )
    ...
    op.add_column(
        "empresas",
        sa.Column("auto_codificar_nuevo_articulo", sa.Boolean(), default=True),
    )
    op.add_column(
        "empresas", sa.Column("tamano_codigo_articulo", sa.Integer(), default=16)
    )
    op.add_column("empresas", sa.Column("id_tarifa_predeterminada", sa.Integer()))
    op.add_column(
        "empresas",
        sa.Column("margen_beneficio_predeterminado", sa.Float(), default=0.0),
    )
    op.add_column(
        "empresas", sa.Column("margen_minimo_predeterminado", sa.Float(), default=0.0)
    )
    op.add_column(
        "empresas", sa.Column("decimales_en_precios", sa.Integer(), default=2)
    )
    op.add_column(
        "empresas", sa.Column("decimales_en_importes_finales", sa.Integer(), default=2)
    )

    # Información adicional
    op.add_column(
        "empresas", sa.Column("sitio_web", sa.String(200))
    )  # Campo adicional para web
    ...
    op.add_column(
        "empresas", sa.Column("google_calendar_refresh_token", sa.String(255))
    )
    op.add_column("empresas", sa.Column("google_calendar_token_expiry", sa.String(255)))

    # contabilidad
    op.add_column(
        "empresas", sa.Column("digitos_cuenta_contable", sa.Integer(), default=8)
    )
    ...
    op.add_column(
        "empresas", sa.Column("cuenta_contable_venta_mercaderias", sa.String(50))
    )
    op.add_column(
        "empresas", sa.Column("cuenta_contable_venta_servicios", sa.String(50))
    )
    op.add_column(
        "empresas", sa.Column("cuenta_contable_iva_soportado_general", sa.String(50))
    )
    op.add_column(
        "empresas", sa.Column("cuenta_contable_iva_soportado_reducido", sa.String(50))
    )
    op.add_column(
        "empresas",
        sa.Column("cuenta_contable_iva_soportado_superreducido", sa.String(50)),
    )
    op.add_column(
        "empresas", sa.Column("cuenta_contable_iva_soportado_exento", sa.String(50))
    )
    op.add_column(
        "empresas",
        sa.Column(
            "cuenta_contable_iva_soportado_recargo_equivalencia_general", sa.String(50)
        ),
    )
    op.add_column(
        "empresas",
        sa.Column(
            "cuenta_contable_iva_soportado_recargo_equivalencia_reducido", sa.String(50)
        ),
    )
    op.add_column(
        "empresas",
        sa.Column(
            "cuenta_contable_iva_soportado_recargo_equivalencia_superreducido",
            sa.String(50),
        ),
    )
    op.add_column(
        "empresas",
        sa.Column(
            "cuenta_contable_iva_soportado_recargo_equivalencia_exento", sa.String(50)
        ),
    )

    op.add_column(
        "empresas", sa.Column("cuenta_contable_iva_repercutido_general", sa.String(50))
    )
    op.add_column(
        "empresas", sa.Column("cuenta_contable_iva_repercutido_reducido", sa.String(50))
    )
    op.add_column(
        "empresas",
        sa.Column("cuenta_contable_iva_repercutido_superreducido", sa.String(50)),
    )
    op.add_column(
        "empresas", sa.Column("cuenta_contable_iva_repercutido_exento", sa.String(50))
    )
    op.add_column(
        "empresas",
        sa.Column(
            "cuenta_contable_iva_repercutido_recargo_equivalencia_general",
            sa.String(50),
        ),
    )
    op.add_column(
        "empresas",
        sa.Column(
            "cuenta_contable_iva_repercutido_recargo_equivalencia_reducido",
            sa.String(50),
        ),
    )
    op.add_column(
        "empresas",
        sa.Column(
            "cuenta_contable_iva_repercutido_recargo_equivalencia_superreducido",
            sa.String(50),
        ),
    )
    op.add_column(
        "empresas",
        sa.Column(
            "cuenta_contable_iva_repercutido_recargo_equivalencia_exento", sa.String(50)
        ),
    )
    # Accesos y seguridad
    op.add_column(
        "empresas", sa.Column("motor_base_datos", sa.String(50), default="sqlite")
    )
    ...
    op.add_column(
        "empresas", sa.Column("puerto_postgresql", sa.Integer(), default=5432)
    )
    ...
    op.add_column(
        "empresas",
        sa.Column("fecha_modificacion", sa.DateTime(), default=sa.func.now()),
    )
