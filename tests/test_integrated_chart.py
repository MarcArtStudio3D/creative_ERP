...
class MockController:
    ...
    def load_by_id(self, article_id):
        ...
        for i, month in enumerate(months):
            ...
            amount = units * (
                self._current_article["coste"]
                * (1 + self._current_article["margen"] / 100)
            )
    ...
    try:
        ...
        for i, month in enumerate(months):
            ...
            if hasattr(window.ui, units_field):
                ...
                units = window.controller._current_article.get(
                    f"unidades_vendidas_{month}", 0
                )
            ...
            if hasattr(window.ui, amount_field):
                ...
                amount = window.controller._current_article.get(
                    f"importe_ventas_{month}", 0
                )
