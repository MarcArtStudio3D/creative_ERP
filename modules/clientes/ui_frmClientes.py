...
"font: 14pt \"Sans Serif\";")
        ...
        icon3 = QIcon()
        icon3.addFile(u":/PNG/resources/icons/png/undo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/PNG/resources/icons/png/search.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/PNG/resources/icons/png/Previous.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/PNG/resources/icons/png/Next.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/Icons/PNG/users.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"color: rgb(255,255,255);")
        ...
        icon9 = QIcon()
        icon9.addFile(u":/PNG/Add.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/PNG/Edit.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/PNG/delete.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/PNG/Save.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/PNG/undo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/Icons/PNG/Fp.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
