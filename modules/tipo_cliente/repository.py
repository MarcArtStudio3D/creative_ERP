...
class TipoClienteRepository:
    ...
    def crear_tipo(self, nombre: str, desc: str = "") -> TipoCliente:
        ...
        tipo = TipoCliente(nombre=nombre.strip(), desc=desc.strip() if desc else None)
    ...
    def obtener_subtipos(self, id_tipo: int) -> List[TipoSubCliente]:
        ...
        """
        stmt = (
            select(TipoSubCliente)
            .where(TipoSubCliente.id_tipocliente == id_tipo)
    ...
    def crear_subtipo(
        self, id_tipo: int, nombre: str, desc: str = ""
    ) -> TipoSubCliente:
        """
    ...
    def actualizar_subtipo(
        self, id_subtipo: int, nombre: str, desc: str = ""
    ) -> TipoSubCliente:
        """
    ...
    def buscar_tipos(self, termino: str) -> List[TipoCliente]:
        ...
        stmt = (
            select(TipoCliente)
            .where(
                or_(TipoCliente.nombre.like(termino), TipoCliente.desc.like(termino))
            )
    ...
    def buscar_subtipos(
        self, termino: str, id_tipo: Optional[int] = None
    ) -> List[TipoSubCliente]:
        """
        ...
        stmt = select(TipoSubCliente).where(
            or_(TipoSubCliente.nombre.like(termino), TipoSubCliente.desc.like(termino))
        )
