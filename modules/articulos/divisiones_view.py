...
class DivisionesView(QDialog):
    ...
    def _conectar_senales(self):
        ...
        self.ui.listSubfamilias.itemSelectionChanged.connect(self._on_subfamilia_selected)
        ...
        self.ui.listSecciones.mousePressEvent = self._create_deselect_handler(self.ui.listSecciones, self._deseleccionar_seccion)
        self.ui.listFamilias.mousePressEvent = self._create_deselect_handler(self.ui.listFamilias, self._deseleccionar_familia)
        self.ui.listSubfamilias.mousePressEvent = self._create_deselect_handler(self.ui.listSubfamilias, self._deseleccionar_subfamilia)
    ...
    def _on_subfamilia_selected(self):
        ...
        if items:
            ...
            # Cargar datos y habilitar edición
            self._cargar_datos_edicion(subfamilia.codigo, subfamilia.subfamilia, 'subfamilia')
    ...
    def _deseleccionar_familia(self):
        ...
        if self.controller.seccion_actual:
            self._cargar_datos_edicion(self.controller.seccion_actual.codigo, 
                                     self.controller.seccion_actual.seccion, 'seccion')
        else:
            self._limpiar_formulario()
    ...
    def _deseleccionar_subfamilia(self):
        ...
        if self.controller.familia_actual:
            self._cargar_datos_edicion(self.controller.familia_actual.codigo, 
                                     self.controller.familia_actual.familia, 'familia')
