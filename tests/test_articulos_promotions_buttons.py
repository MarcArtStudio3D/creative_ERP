...
def test_add_edit_buttons_disabled_when_editing_other_tabs(qapp):
    ...
    assert not v.ui.botAnadir.isEnabled(), "botAnadir should be disabled while editing in non-promotions tabs"
    assert not v.ui.botEditar.isEnabled(), "botEditar should be disabled while editing in non-promotions tabs"
