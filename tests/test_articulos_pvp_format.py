...
def test_articles_table_pvp_format():
    ...
    article = {'codigo': 'TST001', 'descripcion_reducida': 'Test', 'stock_real': 5, 'coste': 10.0, 'margen': 25}
    try:
    ...
    article2 = {'codigo': 'TST002', 'descripcion_reducida': 'Test2', 'stock_real': 3, 'precio_venta': 99.95}
    ...
    article3 = {'codigo': 'TST003', 'descripcion_reducida': 'Test3', 'stock_real': 1, 'precio_venta': None}
    try:
