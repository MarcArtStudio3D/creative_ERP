...
def upgrade() -> None:
    ...
    op.add_column(
        "empresas",
        sa.Column(
            "nombre_base_datos_maria_db",
            sa.String(100),
            nullable=True,
            comment="Nombre de la base de datos MariaDB/PostgreSQL",
        ),
    )
    op.add_column(
        "empresas",
        sa.Column(
            "nombre_base_datos_postgresql",
            sa.String(100),
            nullable=True,
            comment="Nombre de la base de datos PostgreSQL",
        ),
    )
    op.add_column(
        "empresas",
        sa.Column(
            ...
            nullable=True,
            default="localhost",
            comment="Host del servidor MariaDB",
        ),
    )
    op.add_column(
        "empresas",
        sa.Column(
            ...
            nullable=True,
            default=3306,
            comment="Puerto del servidor MariaDB",
        ),
    )
    op.add_column(
        "empresas",
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            nullable=True,
            default="localhost",
            comment="Host del servidor PostgreSQL",
        ),
    )
    op.add_column(
        "empresas",
        sa.Column(
            ...
            nullable=True,
            default=5432,
            comment="Puerto del servidor PostgreSQL",
        ),
    )
    op.add_column(
        "empresas",
