...
class TipoClienteView(QDialog):
    ...
    def setup_ui(self):
        ...
        self.btnInsertarenFichaCliente = QPushButton(
            self.tr("Insertar en ficha cliente")
        )
        self.btnInsertarenFichaCliente.clicked.connect(
            self.on_btnInsertarenFichaCliente_clicked
        )
    ...
    def on_btnAddTipo_clicked(self):
        ...
        try:
            ...
            show_info(
                self, self.tr("Éxito"), self.tr("Tipo cliente insertado con éxito")
            )
    ...
    def on_btnEditarTipo_clicked(self):
        ...
        try:
            ...
            show_info(
                self, self.tr("Éxito"), self.tr("Tipo cliente actualizado con éxito")
            )
    ...
    def on_btnBorrarTipo_clicked(self):
        ...
        reply = show_question(
            ...
            self.tr(
                "¿Está seguro de que desea borrar este tipo?\nSe eliminarán también todos sus subtipos."
            ),
    ...
    def on_btnAddSubTipo_clicked(self):
        ...
        try:
            ...
            show_info(
                self, self.tr("Éxito"), self.tr("Subtipo cliente insertado con éxito")
            )
    ...
    def on_btnEditarSubTipo_clicked(self):
        ...
        if self.current_subtipo_id is None:
            show_warning(
                ...
                self.tr(
                    "Por favor, seleccione el subtipo de cliente\nque desea editar."
                ),
            )
            return
        ...
        try:
            ...
            show_info(
                self, self.tr("Éxito"), self.tr("Subtipo cliente actualizado con éxito")
            )
    ...
    def on_btnBorrarSubTipo_clicked(self):
        ...
        try:
            ...
            show_info(
                self, self.tr("Éxito"), self.tr("Subtipo cliente borrado con éxito")
            )
