...
class Ui_FrmKit(object):
    def setupUi(self, FrmKit):
        ...
        self.frame_3.setStyleSheet(u"background-color: rgb(255, 85, 0);")
...
"color: rgb(0, 0, 0);")
        ...
        self.spinDto.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"")
        ...
        self.frame_4.setStyleSheet(u"background-color: rgb(170, 152, 158);")
        ...
        self.frame_2.setStyleSheet(u"background-color: rgb(170, 152, 158);")
