...
from modules.facturas.models import EstadoFactura, Factura, LineaFactura, TipoFactura
...
class FacturaRepository(BaseRepository[Factura]):
    ...
    def _update(self, factura: Factura) -> Factura:
        ...
        self.db.execute(
            "DELETE FROM lineas_factura WHERE factura_id = ?", (factura.id,)
        )
        self._save_lineas(factura)
    ...
    def delete(self, factura_id: int) -> bool:
        ...
        self.db.execute(
            "DELETE FROM lineas_factura WHERE factura_id = ?", (factura_id,)
        )
    ...
    def _row_to_entity(self, row) -> Factura:
        ...
        factura = Factura(
            ...
            fecha_vencimiento=(
                date.fromisoformat(row["fecha_vencimiento"])
